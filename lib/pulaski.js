...
Pulaski.Instance.prototype.next = function (cb) {
    this.getJSON("playback/next", function (err, res) {
        if (cb != null) {
            cb(err, res);
        }
    });
...
Pulaski.Instance.prototype.previous = function (cb) {
    this.getJSON("playback/previous", function (err, res) {
        if (cb != null) {
            cb(err, res);
        }
    });
...
Pulaski.Instance.prototype.playpause = function (cb) {
    this.getJSON("playback/playpause", function (err, res) {
        if (cb != null) {
            cb(err, res);
        }
    });
...
Pulaski.Instance.prototype.play = function (cb) {
    this.getJSON("playback/play", function (err, res) {
        if (cb != null) {
            cb(err, res);
        }
    });
...
Pulaski.Instance.prototype.pause = function (cb) {
    this.getJSON("playback/pause", function (err, res) {
        if (cb != null) {
            cb(err, res);
        }
    });
...
Pulaski.Instance.prototype.volume = function (cb) {
    this.getJSON("playback/volume", function (err, res) {
        if (cb != null) {
            cb(err, res);
        }
    });
